...
<script>
  ...
  import relations from '../../data/similarityMatrix.json'
  import speaks from '../../data/dayVectors.json'

  export default {
    data() {
      return {
        names: ['雷鑫鑫', '李星', '彭年', '熊若非', '刘旭东', '张汝佳', '王莘然', '鲁超东', '高谭', '曾昭翔', '王路远', '杨逸洲', '赵楠', '张老师', '黄仁浩', '邓平', '殷俊威', '栾金晖', '任宇航', '朱士辉', '马启迪', '彭仁金', '高云聪', '徐志良', '邱阳', '张秀珍', '胡越', '侯班', '张露旖'
          ],
        xnames:['雷', '星', '年', '熊', '旭', '佳', '莘', '鲁', '谭', '翔', '远', '洲', '楠', '张', '黄', '平', '殷', '栾', '任', '朱', '马', '金', '聪', '良', '阳', '秀', '越', '侯', '露'],
